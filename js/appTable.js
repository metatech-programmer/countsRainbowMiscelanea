...
function renderCounts(countsToRender) {
  ...
  totalVenta.setAttribute('title', `Total Ventas del día: $${total.toLocaleString()}`);
  totalJER.innerHTML = `$${totalJERValue.toLocaleString()}`;
  totalJER.setAttribute('title', `Total JER del día: $${totalJERValue.toLocaleString()}`);
  totalGastos.innerHTML = `$${totalGastosValue.toLocaleString()}`;
  totalGastos.setAttribute('title', `Total Gastos del día: $${totalGastosValue.toLocaleString()}`);
